...
st.set_page_config(page_title='Text2Stat - UMP', page_icon='src/img/textpng.png', layout="centered")
...
def main():
    ...
    with col2:
        ...
        #st.markdown('<img src="+open(`src/img/Text.png`).read()+" alt="imane">', unsafe_allow_html=True)
        #components.html("<img src='Text.png' alt='imane'>", height=100)

    with col3:
        st.write("")

    st.sidebar.header(" [ump.ma](http://www.ump.ma/)")
