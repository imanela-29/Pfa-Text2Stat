...
def write():
    ...
    col1.info("To Extract and Analyze the text content of Notes Page   [[ ump.ma/notes ]](http://www.ump.ma/fr/notes) Click the next button")
    col2.write("")
    ...
    if (col2.button('Extraction et Analyse')):
        if Path('ar_event.txt').is_file() & Path('fr_event.txt').is_file() & Path('out_ar_event.txt').is_file() & Path('out_fr_event.txt').is_file() & Path('wordcloud_ar_event.png').is_file() & Path('wordcloud_fr_event.png').is_file() & Path('out_ar_event1.txt').is_file() & Path('out_fr_event1.txt').is_file():
            ...
            os.remove("out_ar_notes1.txt")
            os.remove("out_fr_notes1.txt")
        ...
        out1 = open("out_ar_notes1.txt","w",encoding="utf-8") 
        ...
        mots = open("out_ar_notes1.txt","r",encoding="utf-8") 
        file = mots.read(386000000)

        pretreated=file

        out2 = open("out_ar_notes.txt","w",encoding="utf-8") 
        ...
        out3 = open("out_fr_notes1.txt","w",encoding="utf-8") 
        ...
        mots = open("out_fr_notes1.txt","r",encoding="utf-8") 
        file = mots.read(386000000)

        pretreated=file

        out4 = open("out_fr_notes.txt","w",encoding="utf-8") 
    ...
    with col1:
        if Path('wordcloud_ar_notes.png').is_file():
