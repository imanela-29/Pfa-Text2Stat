...
def write():
    ...
    col1.info("To Extract and Analyze the text content of News Page     [[ ump.ma/actualite ]](http://www.ump.ma/fr/actualite) Click the next button")
    col2.write("")
    if (col2.button('Extraction and Analysis')):
        if Path('ar_actu.txt').is_file() & Path('fr_actu.txt').is_file() & Path('out_ar_actu.txt').is_file() & Path('out_fr_actu.txt').is_file() & Path('wordcloud_ar_actu.png').is_file() & Path('wordcloud_fr_actu.png').is_file() & Path('out_ar_actu1.txt').is_file() & Path('out_fr_actu1.txt').is_file():
            os.remove("ar_actu.txt")
            os.remove("fr_actu.txt")
            os.remove("out_ar_actu1.txt")
            os.remove("out_fr_actu1.txt")
        ...
        out1 = open("out_ar_actu1.txt","w",encoding="utf-8") 
        ...
        mots = open("out_ar_actu1.txt","r",encoding="utf-8") 
        file = mots.read(386000000)

        pretreated=file

        out2 = open("out_ar_actu.txt","w",encoding="utf-8") 
        ...
        out3 = open("out_fr_actu1.txt","w",encoding="utf-8") 
        ...
        mots = open("out_fr_actu1.txt","r",encoding="utf-8") 
        file = mots.read(386000000)

        pretreated=file

        out4 = open("out_fr_actu.txt","w",encoding="utf-8") 
        ...
        #read text
        f1 = open('out_ar_actu.txt' , mode='r', encoding='utf-8')
        text1 = arabic_reshaper.reshape(f1.read())
        text1 = get_display(text1)

        f2 = open('out_fr_actu.txt' , mode='r', encoding='utf-8')
    ...
    with col1:
        if Path('wordcloud_ar_actu.png').is_file():
    ...
    with col2:
        if Path('wordcloud_fr_actu.png').is_file():
